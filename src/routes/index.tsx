...
const PRATOS = [
  {
    ...
    desc: "Espaço reservado para um prato do cardápio oficial, com foto, descrição e preço.",
  },
  {
    img: prato2,
    nome: "Opção vegana",
    desc: "Espaço reservado para uma criação vegetal do cardápio oficial do Bistrô Odoyá.",
  },
  {
    img: prato3,
    nome: "Do mar",
    desc: "Espaço reservado para um prato do mar do cardápio oficial, com foto e descrição.",
  },
];

const GALERIA = [
  { img: ambiente1, alt: "Área externa com mesas de madeira e plantas", span: "row-span-2" },
  { img: prato2, alt: "Prato vegetariano servido em louça artesanal", span: "" },
  { img: ambiente2, alt: "Detalhes de decoração em fibras naturais e cerâmica", span: "" },
  { img: galeria1, alt: "Mesa de madeira com vaso de folhagem e luz natural", span: "" },
  { img: prato3, alt: "Prato do mar com ervas frescas e limão", span: "" },
  { img: experiencia, alt: "Preparo artesanal de um prato na cozinha", span: "md:col-span-2" },
];
  ...
  return (
    <div id="topo" className="w-full overflow-x-hidden">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 md:grid-cols-2 md:items-center md:gap-16 md:px-8">
          <div>
            ...
            <div className="mt-6 space-y-5 text-[0.98rem] leading-relaxed text-muted-foreground">
              <p>
                O Bistrô Odoyá nasce da vontade de receber bem em Maresias. Na Praia do Saco,
                em São Sebastião, a casa reúne cozinha artesanal, ingredientes frescos e um
                ambiente pensado para quem quer comer com calma.
              </p>
              <p>
                A proposta é simples e cuidadosa: uma cozinha brasileira com inspiração
                sul-americana, atenção à comida saudável e opções para diferentes preferências
                alimentares — inclusive vegetarianas e veganas.
              </p>
              <p>
                Cada visita é pensada como uma pausa: o tempo do litoral, a luz natural, o
                verde ao redor e pratos preparados no ritmo da casa.
              </p>
            </div>
          </div>
          <div className="relative">
            <img
              src={ambiente1}
              alt="Área externa do bistrô com mesas de madeira, plantas e vista para a praia"
              width={1200}
              height={1500}
              loading="lazy"
            ...
            <div className="mt-4 flex items-center gap-3 text-sm text-muted-foreground">
              ...
              <span>Cozinha artesanal, natureza e aconchego à beira do litoral norte.</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-[0.98rem] leading-relaxed text-primary-foreground/80">
              Pratos preparados de forma artesanal, com foco em sabor e equilíbrio. Uma cozinha
              que atravessa referências brasileiras e sul-americanas e acolhe também quem segue
              uma alimentação vegetariana ou vegana.
            </p>
          </div>

          <ul className="mt-14 grid gap-px overflow-hidden rounded-sm bg-primary-foreground/15 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ["Culinária brasileira", "Receitas de raiz brasileira, com ingredientes frescos."],
              ["Inspiração sul-americana", "Referências e temperos do continente no prato."],
              ["Comida saudável", "Preparos leves e equilibrados, sem abrir mão do sabor."],
              ["Opções vegetarianas", "Alternativas sem carne pensadas com o mesmo cuidado."],
              ["Opções veganas", "Criações 100% vegetais disponíveis na casa."],
              ["Pratos artesanais", "Cozinha feita à mão, no ritmo do bistrô."],
            ].map(([titulo, texto]) => (
              <li key={titulo} className="bg-primary p-8">
                <h3 className="font-display text-2xl">{titulo}</h3>
                <p className="mt-3 text-sm leading-relaxed text-primary-foreground/75">{texto}</p>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="section-pad bg-background">
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          <div className="max-w-2xl">
            <Eyebrow>Destaques do Cardápio</Eyebrow>
            <span className="rule-line mt-5" />
            <h2 className="mt-6 font-display text-4xl leading-tight md:text-5xl">
              Em breve, os pratos da casa
            </h2>
            <p className="mt-5 text-[0.98rem] leading-relaxed text-muted-foreground">
              Os cards abaixo são espaços preparados para receber o cardápio oficial do Bistrô
              Odoyá — foto, nome, descrição e preço. As imagens são ilustrativas e não
              representam pratos oficiais.
            </p>
          </div>
      ...
      <section className="section-pad bg-secondary">
        <div className="mx-auto grid max-w-6xl gap-12 px-5 md:grid-cols-2 md:items-center md:px-8">
          <img
            src={experiencia}
            alt="Preparo artesanal de um prato em cozinha rústica com luz natural"
            width={1400}
            height={1000}
            loading="lazy"
          ...
          <div className="order-1 md:order-2">
            ...
            <ul className="mt-8 space-y-5">
              {[
                ["Ambiente acolhedor", "Um espaço tranquilo para refeições sem pressa."],
                ["Contato com a natureza", "Plantas, madeira e luz natural compõem a casa."],
                ["Para diferentes preferências", "Opções vegetarianas e veganas no cardápio."],
                ["Cozinha artesanal", "Pratos preparados com cuidado, do início ao fim."],
              ].map(([t, d]) => (
      ...
      <section id="galeria" className="section-pad bg-background">
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-[0.98rem] leading-relaxed text-muted-foreground">
              Espaço preparado para receber as fotos oficiais do Bistrô Odoyá — pratos,
              ambiente, decoração e área externa. As imagens atuais são ilustrativas.
            </p>
          </div>
          ...
          <div className="mt-12 grid auto-rows-[220px] grid-cols-1 gap-4 sm:grid-cols-2 md:auto-rows-[260px] md:grid-cols-3">
            {GALERIA.map((g, i) => (
              <figure
                key={i}
                className={`overflow-hidden rounded-sm ${g.span} ${i === 0 ? "sm:row-span-2" : ""}`}
              >
                <img
                  src={g.img}
                  alt={g.alt}
        ...
        <div className="mx-auto max-w-6xl px-5 md:px-8">
          ...
          {AVALIACOES.length > 0 ? (
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {AVALIACOES.map((a) => (
                <blockquote key={a.nome} className="rounded-sm border border-border bg-card p-7">
            ...
            <div className="mt-12 rounded-sm border border-dashed border-border bg-card p-10 text-center">
              ...
              <p className="mx-auto mt-5 max-w-lg text-sm leading-relaxed text-muted-foreground">
                Esta seção está preparada para receber avaliações reais de clientes, com nome,
                nota, comentário e estrelas. Enquanto isso, você pode falar diretamente com a
                casa pelo WhatsApp.
              </p>
              <a
                href={RESTAURANTE.whatsapp}
            ...
            <div>
              ...
              <div className="mt-10 rounded-sm border border-border bg-card p-7">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-display text-2xl">Horários de funcionamento</h3>
                </div>
                <ul className="mt-5 divide-y divide-border">
                  {HORARIOS.map((h) => (
                    ...
                    >
                      ...
                      <span
                        className={
                          h.horario === "Fechado" ? "text-muted-foreground" : "text-clay"
                        }
                      >
                        {h.horario}
                      </span>
      ...
      <section className="section-pad bg-secondary">
        <div className="mx-auto max-w-4xl px-5 text-center md:px-8">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[0.98rem] leading-relaxed text-muted-foreground">
            Acompanhe o dia a dia da casa, os pratos e o ambiente pelo nosso perfil.
          </p>
          <div className="mt-9 grid grid-cols-3 gap-3">
            {[prato1, ambiente2, prato3].map((img, i) => (
              <img
                key={i}
                src={img}
                alt="Imagem ilustrativa do ambiente e da gastronomia do bistrô"
                loading="lazy"
      ...
      <section id="contato" className="relative">
        <img
          src={ambiente1}
          alt="Mesas ao ar livre do bistrô ao entardecer"
          loading="lazy"
          className="absolute inset-0 h-full w-full object-cover"
        />
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-24 text-center md:px-8 md:py-32">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[0.98rem] leading-relaxed text-background/85">
            Venha conhecer o Bistrô Odoyá, na Praia do Saco. Fale com a gente para tirar dúvidas
            sobre a casa, o cardápio e a sua visita.
          </p>
          <a
            href={RESTAURANTE.whatsapp}
            target="_blank"
      ...
      <footer className="bg-primary text-primary-foreground">
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-16 sm:grid-cols-2 lg:grid-cols-4 md:px-8">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.18em]">Endereço</h3>
          ...
          <nav>
            <h3 className="text-sm font-semibold uppercase tracking-[0.18em]">Navegação</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.18em]">Horários</h3>
            <ul className="mt-4 space-y-1.5 text-sm text-primary-foreground/80">
              {HORARIOS.map((h) => (
                <li key={h.dia} className="grid grid-cols-[minmax(0,1fr)_auto] gap-3">
        ...
        <div className="border-t border-primary-foreground/15">
          <p className="mx-auto max-w-6xl px-5 py-6 text-xs text-primary-foreground/70 md:px-8">
            © {new Date().getFullYear()} Bistrô Odoyá — Maresias, São Sebastião · SP. Todos os
            direitos reservados.
          </p>
        </div>
      </footer>
